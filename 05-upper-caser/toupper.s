...
#                           if the byte us a lower-case letter,
...
# options for open (look at /usr/include/asm/fctl.h for various values.
...
.section .bss
# Buffer - this is to where the data is loaded from the data file and 
#          written into the output file. This should never exceed 16,000
#          for various readons.
.equ BUFFER_SIZE, 500
...
# PURPOSE: This function actually does the conversion to uppercase for a 
#          block.
#
...
.equ LOWERCASE_Z, 'z'
# Conversion between upper and lowercase
